...
public class Produto {
    ...
    public Produto(String resumida, double custoUnidade){
        this.resumida = resumida;
        this.custoUnidade = custoUnidade;
    }
    
    public Produto(int codigoProduto, String resumida, double preco, double qtdEstoque, String unidadeMedida, double desconto, double valorVenda){
    ...
    public Produto(int codigoProduto, String resumida, double preco, double qtdEstoque, String unidadeMedida, double desconto, double valorVenda,double custoUnidade){
        this.codigoProduto = codigoProduto;
        this.resumida = resumida;
        this.preco = preco;
        this.qtdEstoque = qtdEstoque;
