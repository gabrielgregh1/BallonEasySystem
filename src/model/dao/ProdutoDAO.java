...
public class ProdutoDAO {
    ...
    public void create(Produto p){
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO produto(codigoProduto, controleExtra,"
                    ...
                    + ", desconto, ncm, cest,preco, fk_fornecedor) VALUES(default, ?, ?, ?, ?,  CURDATE(), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?)");
    ...
    public List<Produto> read(){
        ...
        try {
                stmt = con.prepareStatement("SELECT codigoProduto, controleExtra, codigoBarras, resumida, completa, dataInclusao,"
                        + " qtdMinima, qtdMaxima, qtdEstoque,unidadeMedida, valorVenda, custoSemImposto, custoUnidade, lucrativo, "
                        + " desconto, ncm, cest,preco, fk_fornecedor, nomeInstituicao FROM PRODUTO, fornecedor " 
                        + " WHERE fk_fornecedor = codigo;");
            ...
            while(rs.next()){
                ...
                String nomeFornecedor = rs.getString("nomeInstituicao");
      
                forn = new Fornecedor(idFornecedor, nomeFornecedor);
